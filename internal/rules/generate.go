...
//go:generate go run ../gen-rules/main.go ../../third-party/hadolint/src/Hadolint/Rule
//go:generate go run ../gen-tests/main.go ../../third-party/hadolint/test/Hadolint/Rule
