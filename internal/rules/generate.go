...
//go:generate go run ../../hack/gen-rules/main.go ../../third-party/hadolint/src/Hadolint/Rule
//go:generate go run ../../hack/gen-tests/main.go ../../third-party/hadolint/test/Hadolint/Rule
